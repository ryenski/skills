...
- **[rails-patterns](./rails-patterns/SKILL.md)** — Object-oriented design patterns for Rails: service objects, form objects, decorators, strategies, and when to extract from models.
- **[tdd](./tdd/SKILL.md)** — Test-driven development with a red-green-refactor loop using Minitest and fixtures. Builds features or fixes bugs one vertical slice at a time.
